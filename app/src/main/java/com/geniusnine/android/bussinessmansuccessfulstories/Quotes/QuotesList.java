package com.geniusnine.android.bussinessmansuccessfulstories.Quotes;
...
import com.geniusnine.android.bussinessmansuccessfulstories.IndiaTopEnterpreneurs.CallIndianEnterpreneurDetails;
import com.geniusnine.android.bussinessmansuccessfulstories.QuotesListDetails;
import com.geniusnine.android.bussinessmansuccessfulstories.R;
//calling quoteslist in webview
public class QuotesList extends  AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView = (ListView) findViewById(R.id.quoteslistView);

        String[] values = new String[]{"\"The critical ingredient is getting off your butt " +
                ...
                "doomed if you don't try.\"","“When you cease to dream you cease to live”","“Don’t worry about funding if you don’t need it. " +
                ...
                "when their glass is really four-fifths full. I’m grateful when I have one drop " +
                "in the glass because I know exactly what to do with it.”","“It's hard to beat a person who never gives up.”"};
            getSupportActionBar().setDisplayHomeAsUpEnabled(true);
            ArrayAdapter<String> adapter = new ArrayAdapter<String>(this, R.layout.activity_quotes_list, R.id.quotestextView, values);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent i = new Intent(QuotesList.this, QuotesListDetails.class);
